...
console.log(lorem.substring(2, 10));
console.log(lorem.slice(-10));


console.log(lorem.indexOf('i'));
console.log(lorem.length);
console.log(lorem.indexOf('i', 10));
console.log(lorem.lastIndexOf('i'));

console.log(lorem.startsWith("+91"));
console.log(lorem.endsWith("+91"));
...
let mynewstring = String.raw `\u2178`.length;
